      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-6">
          ...
          <section className="rounded-3xl border border-neutral-200 bg-white p-7 sm:p-9 shadow-xs hover:border-neutral-300 transition">
            ...
            <p className="text-sm sm:text-base text-neutral-700 leading-relaxed pl-11">
              Under UK GDPR, you maintain rights to access, rectify, export, or erase your telemetry records by reaching our Data Protection Officer at <code className="font-mono bg-neutral-50 border border-neutral-200 px-2 py-0.5 rounded text-black font-semibold">privacy@innotek.global</code>.
            </p>
          </section>
        </div>
