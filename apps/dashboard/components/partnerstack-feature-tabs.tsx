...
export function PartnerStackFeatureTabs() {
  ...
  return (
    <section id="features" className="scroll-mt-24 py-20 sm:py-28 bg-white text-[#09090B] overflow-hidden relative border-t border-b border-neutral-200/80 font-sans">
